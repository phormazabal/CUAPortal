...
{
    public partial class ExamenImagenes : System.Web.UI.Page
    {
        ...
        protected void grdExam_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "A":
                    ...
                    Server.Transfer("DetalleExamen.aspx?r=" + hdMaster.Value + "&o=1");
                    break;
                case "C":
