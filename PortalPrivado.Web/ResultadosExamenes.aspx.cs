...
{
    public partial class ResultadosExamenes : System.Web.UI.Page
    {
        ...
        protected void grdExam_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "A":
                    ...
                    Server.Transfer("DetalleExamen.aspx?r=" + hdMaster.Value + "&o=0");
                    break;
                case "C":
