<%@ Page Title="" Language="C#" MasterPageFile="~/PortalM.Master" AutoEventWireup="true" CodeBehind="ExamenImagenes.aspx.cs" Inherits="PortalPrivado.Web.ExamenImagenes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    ...
    <div class="box-perfil sin-padding b-con-tabla">
                            ...
                            <asp:ListView ID="grdExam" runat="server" DataKeyNames="accession_number" OnPagePropertiesChanging="grdHistorico_PagePropertiesChanging" OnItemCommand="grdExam_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>Imágenes</td>
                                        <td>
                                            <asp:Label ID="lbProfesional" runat="server" Text='<%# Eval("informante") %>'></asp:Label></td>
                                        ...
                                        <td class="col-accion col-btn">
                                            <asp:LinkButton ID="LinkButton1" CommandName="A" runat="server">
        ...
        <div class="d-flex-descargar">
            <asp:LinkButton ID="lnkCompartir" CssClass="btn btn-amarillo" runat="server" OnClick="lnkCompartir_Click">COMPARTIR SELECCIONADOS</asp:LinkButton>
