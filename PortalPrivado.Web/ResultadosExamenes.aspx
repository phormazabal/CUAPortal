<%@ Page Title="" Language="C#" MasterPageFile="~/PortalM.Master" AutoEventWireup="true" CodeBehind="ResultadosExamenes.aspx.cs" Inherits="PortalPrivado.Web.ResultadosExamenes" %>
                            ...
                            <asp:ListView ID="grdExam" runat="server" DataKeyNames="accession_number" OnPagePropertiesChanging="grdHistorico_PagePropertiesChanging" OnItemCommand="grdExam_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%# Eval("laboratorio").Equals("1") ? "Laboratorio": "Imágenes" %></td>
                                        <td>
